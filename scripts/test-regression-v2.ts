...
const TESTS: TestDefinition[] = [
  ...
  { id: "01_solo_standard", description: "Seul, énergie moyenne, standard, intérieur", lot: "1_social",
    args: ["--auto", "--persona", "Je veux me détendre ce soir", "--social", "solo", "--energy", "3", "--budget", "standard", "--env", "env_shelter"] },
  { id: "02_friends_outdoor", description: "Amis, haute énergie, standard, extérieur", lot: "1_social",
    args: ["--auto", "--persona", "On veut faire un truc fun entre potes dehors", "--social", "friends", "--energy", "5", "--budget", "standard", "--env", "env_open_air"] },
  { id: "03_couple_luxury", description: "Couple, énergie moyenne, luxe, intérieur", lot: "1_social",
    args: ["--auto", "--persona", "Soirée romantique en amoureux", "--social", "couple", "--energy", "3", "--budget", "luxury", "--env", "env_shelter"] },
  { id: "04_family_free", description: "Famille, énergie haute, gratuit, extérieur", lot: "1_social",
    args: ["--auto", "--persona", "Journée en famille sans dépenser", "--social", "family", "--energy", "4", "--budget", "free", "--env", "env_open_air"] },
  { id: "05_solo_budget", description: "Seul, faible énergie, économique, intérieur", lot: "1_social",
    args: ["--auto", "--persona", "Je suis crevé et je veux un truc pas cher", "--social", "solo", "--energy", "1", "--budget", "budget", "--env", "env_shelter"] },

  // LOT 2 : Enfants
  { id: "06_kids_toddler", description: "Famille, tout-petits 1-3 ans", lot: "2_kids",
    args: ["--auto", "--persona", "Activité avec mon bébé de 2 ans", "--social", "family", "--energy", "3", "--budget", "standard", "--env", "env_shelter", "--children-ages", "1,3"] },
  { id: "07_kids_school", description: "Famille, primaire 6-10 ans", lot: "2_kids",
    args: ["--auto", "--persona", "Activité éducative et amusante", "--social", "family", "--energy", "4", "--budget", "standard", "--env", "env_home", "--children-ages", "6,10"] },
  { id: "08_kids_teen", description: "Famille, ados 13-17 ans, budget", lot: "2_kids",
    args: ["--auto", "--persona", "Activité fun avec des ados", "--social", "family", "--energy", "5", "--budget", "budget", "--env", "env_open_air", "--children-ages", "13,17"] },
  { id: "09_kids_wide_range", description: "Famille, large range 2-12 ans", lot: "2_kids",
    args: ["--auto", "--persona", "Sortie familiale avec enfants d'âges variés", "--social", "family", "--energy", "3", "--budget", "standard", "--env", "env_home", "--children-ages", "2,12"] },

  // LOT 3 : Saisons (la persona guide le LLM)
  { id: "10_timing_summer", description: "Été, couple, extérieur", lot: "3_timing",
    args: ["--auto", "--persona", "Activité estivale en amoureux", "--social", "couple", "--energy", "4", "--budget", "standard", "--env", "env_open_air"] },
  { id: "11_timing_winter", description: "Hiver, famille", lot: "3_timing",
    args: ["--auto", "--persona", "Activité d'hiver en famille", "--social", "family", "--energy", "3", "--budget", "standard", "--env", "env_home"] },
  { id: "12_timing_spring", description: "Printemps, seul, extérieur", lot: "3_timing",
    args: ["--auto", "--persona", "Profiter du printemps seul", "--social", "solo", "--energy", "4", "--budget", "budget", "--env", "env_open_air"] },

  // LOT 4 : Langues
  { id: "13_lang_en_solo", description: "Anglais, seul, intérieur", lot: "4_lang",
    args: ["--auto", "--persona", "I want to relax at home tonight", "--social", "solo", "--energy", "2", "--budget", "standard", "--env", "env_shelter", "--lang", "en"] },
  { id: "14_lang_es_couple", description: "Espagnol, couple, luxe", lot: "4_lang",
    args: ["--auto", "--persona", "Quiero una velada romántica", "--social", "couple", "--energy", "3", "--budget", "luxury", "--env", "env_shelter", "--lang", "es"] },
  { id: "15_lang_fr_reference", description: "Français référence (contrôle)", lot: "4_lang",
    args: ["--auto", "--persona", "Chercher une activité sympa entre amis", "--social", "friends", "--energy", "4", "--budget", "standard", "--env", "env_home"] },

  // LOT 5 : Cas limites énergie/budget
  { id: "16_energy_min", description: "Énergie 1, seul, gratuit", lot: "5_limits",
    args: ["--auto", "--persona", "Je suis épuisé, zéro motivation", "--social", "solo", "--energy", "1", "--budget", "free", "--env", "env_shelter"] },
  { id: "17_energy_max", description: "Énergie 5, amis, luxe, extérieur", lot: "5_limits",
    args: ["--auto", "--persona", "On veut se défoncer physiquement", "--social", "friends", "--energy", "5", "--budget", "luxury", "--env", "env_open_air"] },
  { id: "18_any_env", description: "Environnement indifférent, famille", lot: "5_limits",
    args: ["--auto", "--persona", "On s'en fiche intérieur ou extérieur", "--social", "family", "--energy", "3", "--budget", "standard", "--env", "env_home"] },

  // LOT 6 : Personas spécifiques
  { id: "19_gamer", description: "Gamer seul", lot: "6_persona",
    args: ["--auto", "--persona", "Je veux jouer à un jeu vidéo", "--social", "solo", "--energy", "2", "--budget", "standard", "--env", "env_shelter"] },
  { id: "20_cinema", description: "Cinéma entre amis", lot: "6_persona",
    args: ["--auto", "--persona", "On veut aller au cinéma", "--social", "friends", "--energy", "2", "--budget", "standard", "--env", "env_shelter"] },
  { id: "21_sport", description: "Sport intense", lot: "6_persona",
    args: ["--auto", "--persona", "Je veux faire du sport intense", "--social", "solo", "--energy", "5", "--budget", "budget", "--env", "env_open_air"] },
  { id: "22_creative", description: "Activité créative", lot: "6_persona",
    args: ["--auto", "--persona", "Je veux créer quelque chose de mes mains", "--social", "solo", "--energy", "3", "--budget", "standard", "--env", "env_shelter"] },
  { id: "23_gastronomie", description: "Sortie gastronomique", lot: "6_persona",
    args: ["--auto", "--persona", "On veut découvrir un bon restaurant", "--social", "couple", "--energy", "2", "--budget", "luxury", "--env", "env_shelter"] },
  { id: "24_nature", description: "Randonnée nature", lot: "6_persona",
    args: ["--auto", "--persona", "Je veux me reconnecter avec la nature", "--social", "solo", "--energy", "4", "--budget", "free", "--env", "env_open_air"] },
  { id: "25_zen", description: "Détente zen", lot: "6_persona",
    args: ["--auto", "--persona", "Je veux méditer et me recentrer", "--social", "solo", "--energy", "1", "--budget", "free", "--env", "env_shelter"] },
  { id: "26_adventure", description: "Aventure insolite", lot: "6_persona",
    args: ["--auto", "--persona", "Je cherche une expérience hors du commun", "--social", "friends", "--energy", "5", "--budget", "luxury", "--env", "env_open_air"] },

  // LOT 7 : Combinaisons croisées
  { id: "27_teen_winter", description: "Ados en hiver, intérieur", lot: "7_combo",
    args: ["--auto", "--persona", "Activité intérieure pour ados en hiver", "--social", "family", "--energy", "4", "--budget", "standard", "--env", "env_shelter", "--children-ages", "13,16"] },
  { id: "28_friends_summer_en", description: "Amis, été, anglais", lot: "7_combo",
    args: ["--auto", "--persona", "Summer outdoor activity with friends", "--social", "friends", "--energy", "5", "--budget", "budget", "--env", "env_open_air", "--lang", "en"] },
  { id: "29_family_xmas", description: "Noël en famille, enfants 4-10", lot: "7_combo",
    args: ["--auto", "--persona", "Activité de Noël en famille", "--social", "family", "--energy", "3", "--budget", "standard", "--env", "env_shelter", "--children-ages", "4,10"] },
  { id: "30_full_combo", description: "Combo complet : famille, enfants, luxe", lot: "7_combo",
    args: ["--auto", "--persona", "Weekend de luxe en famille avec les enfants", "--social", "family", "--energy", "4", "--budget", "luxury", "--env", "env_home", "--children-ages", "6,12"] },
];
