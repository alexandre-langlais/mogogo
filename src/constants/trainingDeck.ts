...
export const TRAINING_DECK: TrainingCardData[] = [
  ...
  { id: 2, titleKey: "training.cards.creative",   descriptionKey: "training.desc.creative",   emoji: "🎨", tags: ["creatif"] },
  { id: 3, titleKey: "training.cards.museum",     descriptionKey: "training.desc.museum",     emoji: "📚", tags: ["culture"] },
  ...
  { id: 8, titleKey: "training.cards.diy",        descriptionKey: "training.desc.diy",        emoji: "🏠", tags: ["creatif"] },
];
